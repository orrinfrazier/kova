...
import { resolveRepoConfig, detectRepoName } from '../services/config.js';
...
program
  ...
  .action(async (issueArg: string | undefined, opts: { all?: boolean; filter?: string; max?: string; repo?: string }) => {
